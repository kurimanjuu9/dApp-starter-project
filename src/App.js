...
const App = () => {
  ...
  const contractAddress = "0x899F309d15BA795b3dE34557cA5aB8aEc666a51D";
    ...
    <div className="mainContainer">
      <div className="dataContainer">
        <div className="h1">
          ...
          <div className="bio">
            1⃣ イーサリアムウォレット(Rinkebyテストネットワーク)を接続<br/>
            2⃣ メッセージを入力<br/>
            3⃣ <span role="img" aria-label="hand-wave">👋</span>を送ってください
          </div>
        </div>
